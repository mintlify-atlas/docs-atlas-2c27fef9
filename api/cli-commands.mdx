...
The `simpe` command is configured by editing the variables at the top of `main.py` (lines 14-23). See [Configuration Options](/api/configuration-options) for details.
